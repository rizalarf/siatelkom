...
<div class="content-header">
  <h1>Laporan Harian</h1>
    <ol class="breadcrumb">
      ...
      <li><a href="{{{ action('RolePembLap\RolePembLapController@laporanharian') }}}">Laporan Harian</a></li>
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <form id="formLapharEdit" class="form-horizontal" role="form" method="POST" action="{{ url('/lapharpemb/'.$id.'/simpanedit') }}"><!--Tampilan form pengisian-->
              ...
              <input type="hidden" name="id" value="{{$id}}" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" class="form-control" name="idPas" value="{{$idPas}}">
                    <small class="help-block"></small>
                  </div>
                </div>
                    ...
                    <div class="col-md-6">
                      <div class="input-group">
                        <div class="input-group date" data-provide='datepicker' style="width: 218%;">
                          <input type="text" class="form-control datepicker-me" name="lapTanggal" value="{{$lapTanggal}}">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Isi Kegiatan</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="lapIsi" value="{{$lapIsi}}">
                      <small class="help-block"></small>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Komentar</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="lapKomen" value="{{$lapKomen}}">
                      <small class="help-block"></small>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-md-offset-4">
                    ...
                    <a href="{{{ action('RolePembLap\RolePembLapController@laporanharian') }}}" title="Cancel">
