...
<div class="content-header">
  <h1>Laporan Akhir</h1>
    <ol class="breadcrumb">
      ...
      <li><a href="{{{ action('RoleDosen\RoleDosenController@laporanakhir') }}}">Laporan Akhir</a></li>
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">{{$idPas}} - Edit</h3>
          </div>
          <div class="box-body">
            <form id="formlapakharEdit" class="form-horizontal" role="form" method="POST" action="{{ url('/lapakhirdos/'.$id.'/simpanedit') }}"><!--Tampilan form pengisian-->
              ...
              <input type="hidden" name="id" value="{{$id}}" >
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Nama Mahasiswa</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="idPas" value="{{$idPas}}" disabled="true">
                      <small class="help-block"></small>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                      <div class="input-group">
                        <div class="input-group date" data-provide='datepicker' style="width: 218%;">
                          <input type="text" class="form-control datepicker-me" name="lapakTanggal" value="{{$lapakTanggal}}" disabled="true">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Isi Kegiatan</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="lapakIsi" value="{{$lapakIsi}}" disabled="true">
                      <small class="help-block"></small>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Komentar</label>
                    <div class="col-md-6">
                      <textarea class="form-control" name="lapakKomen">{{$lapakKomen}}</textarea>
                      <small class="help-block"></small>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-md-offset-4">
                    ...
                    <a href="{{{ action('RoleDosen\RoleDosenController@laporanakhir') }}}" title="Cancel">
