      ...
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">{{$data->klsNama}} - Edit</h3>
          </div>
          <div class="box-body">
            <form id="formKelasEdit" class="form-horizontal" role="form" method="POST" action="{{ url('/kelas/'.$data->id.'/simpanedit') }}"><!--Tampilan form pengisian-->
              ...
              <input type="hidden" name="id" value="{{$data->id}}" >
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Nama Kelas</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="klsNama" value="{{$data->klsNama}}">
                      <small class="help-block"></small>
                    </div>
                </div>
