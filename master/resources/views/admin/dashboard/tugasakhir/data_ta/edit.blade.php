...
<div class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Daftar Judul Tugas Akhir - Edit</li>
  </ol>
</div>
    ...
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">{{ $nmMahasiswa }} - Edit</h3>
        </div>
        <div class="box-body">
          <form id="formeditJudul" class="form-horizontal" role="form" method="POST" action="{{ url('/data-tugas-akhir/'.$judul->id.'/update') }}">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="text" class="form-control" name="jdJudul" value="{{ $judul->jdJudul }}">
            </div>
          </div>
