      ...
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">{{$data->idPas}} - Edit</h3>
          </div>
          <div class="box-body">
            <form id="formLapharEdit" class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ url('/lapakhirmhs/'.$data->id.'/simpanedit') }}"><!--Tampilan form pengisian-->
              ...
              <input type="hidden" name="id" value="{{$data->id}}" >
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Mahasiswa</label>
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="idPas" value="{{$data->idPas}}">
                      <small class="help-block"></small>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                      <div class="input-group">
                        <div class="input-group date" data-provide='datepicker' style="width: 218%;">
                          <input type="text" class="form-control datepicker-me" name="lapakTanggal" value="{{$data->lapakTanggal}}">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Isi Kegiatan</label>
                    <div class="col-md-6">
                      <input type="file" class="form-control" name="lapakIsi" value="{{$data->lapakIsi}}">
                      <small class="help-block"></small>
                    </div>
                </div>
