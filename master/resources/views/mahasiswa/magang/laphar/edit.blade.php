    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <form id="formLapharEdit" class="form-horizontal" role="form" method="POST" action="{{ url('/lapharmhs/'.$data->id.'/simpanedit') }}"><!--Tampilan form pengisian-->
              ...
              <input type="hidden" name="id" value="{{$data->id}}" >
                    ...
                    <div class="col-md-6">
                      <div class="input-group">
                        <div class="input-group date" data-provide='datepicker' style="width: 218%;">
                          <input type="text" class="form-control datepicker-me" name="lapTanggal" value="{{$data->lapTanggal}}">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Isi Kegiatan</label>
                    <div class="col-md-6">
                      <textarea class="form-control" name="lapIsi">{{($data->lapIsi)}}</textarea>
                      <small class="help-block"></small>
                    </div>
                </div>
