    ...
    <div class="row">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <a href="{{{ action('RoleMhs\RoleMhsController@tambahharian') }}}" class="btn btn-success btn-flat btn-sm" title="Tambah Laporan Harian"><i class="fa fa-plus"></i></a>
        </div>
        <div class="box-body">
          <table id="demo-dt-basic"  class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="{{{ url('lapharmhs/'.$harianitem->id.'/edit') }}}"class="btn btn-warning btn-icon icon-lg fa fa-pencil"  title="Edit"></a>
                  <a href="{{{ action('RoleMhs\RoleMhsController@hapusharian', [$harianitem->id]) }}}" onclick="return confirm('Apakah Anda yakin akan menghapus laporan harian tanggal {{{$harianitem->lapTanggal}}} ?')" class="btn btn-danger btn-icon icon-xs fa fa-trash" title="Delete"></a>
                </td>
              </tr>
              @endforeach
            </tbody>
