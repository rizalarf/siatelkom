...
<div class="content-header">
  <h1>Laporan Harian</h1>
    <ol class="breadcrumb">
      ...
      <li><a href="{{{ action('RoleMhs\RoleMhsController@laporanharian') }}}">Laporan Harian</a></li>
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <form id="formLapharTambah" class="form-horizontal" role="form" method="POST" action="{{ url('/lapharmhs/tambahlaphar') }}"><!--Tampilan form pengisian-->
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Tanggal</label>
                    <div class="col-md-6 @if ($errors->has('lapTanggal')) has-error @endif">
                      <div class="input-group">
                        <div class="input-group date" data-provide='datepicker' style="width: 218%;">
                          <input type="text" class="form-control datepicker-me" name="lapTanggal" value="{{Request::old('lapTanggal')}}" placeholder="Enter Tanggal">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Isi Kegiatan</label>
                    <div class="col-md-6 @if ($errors->has('lapIsi')) has-error @endif">
                      <textarea class="form-control" name="lapIsi" value="{{Request::old('lapIsi')}}" placeholder="Enter Isi Kegiatan"></textarea>
                      <small class="help-block"></small>
                    </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-md-offset-4">
                    ...
                    <a href="{{{ action('RoleMhs\RoleMhsController@laporanharian') }}}" title="Cancel">
