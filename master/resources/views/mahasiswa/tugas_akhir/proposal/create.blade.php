...
<div class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Judul Tugas Akhir - Create</li>
  </ol>
</div>
  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <form id="formcreateJudul" class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ url('/proposal/store') }}">
         ...
         <div class="form-group">
           ...
           <div class="col-md-6 @if ($errors->has('jdJudul')) has-error @endif">
             ...
             <textarea class="form-control" name="jdJudul" rows="4"></textarea>
           </div>
         </div>
         ...
         <div class="form-group">
           ...
           <div class="col-md-6 @if ($errors->has('jdProposal')) has-error @endif">
             <input accept=".doc, .docx, .pdf" type="file" name="jdProposal">
           </div>
         </div>
