...
<div class="content-header">
  <h1>Kontrol Bimbingan Tugas Akhir</h1>
  <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Selesai Bimbingan</h3>
        </div>
        <div class="box-body">
          <form id="createBimb"class="form-horizontal" role="form" method="POST" action="{{ url('/selesai-bimbingan/store') }}">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="input-group date" data-provide='datepicker'>
                  <input type="text" class="form-control datepicker" name="endTanggal" value="{{ Request::old('endTanggal') }}">
            ...
            <div class="form-group">
              <div class="col-md-6 col-md-offset-4">
                ...
                <a href="{{{ action('RoleMhs\RoleMhsController@indexSelesaiBimbingan') }}}" title="Cancel">
